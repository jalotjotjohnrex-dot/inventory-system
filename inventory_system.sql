...
INSERT INTO `transactions` VALUES (9,NULL,'Charger','Charger','adsd','1233',7,'Rex','- Returned -','2026-03-12','New',1),(10,NULL,'Mouse','mouse','12123','423',8,'Rex','- Returned -','2026-03-12','New',3),(13,NULL,'Tissue','tissue','123','34',13,'Rex','- Returned -','2026-03-12','New',3),(18,NULL,'Mouse','tissue','123','34565',7,'Rex','- Returned -','2026-03-12','Defective',1),(19,NULL,'Bond Paper','paper','dfg','152',1,'Rex','- Returned -','2026-03-12','Defective',1),(23,NULL,'Bond Paper','paper','457','78m',1,'Rex','- Returned -','2026-03-13','New',1),(24,NULL,'Screw Driver','Hardware','145','m34',13,'Rex','- Returned -','2026-03-13','New',1),(25,NULL,'Screw Driver','Hardware','148','m37',13,'Rex','- Returned -','2026-03-13','New',1),(28,NULL,'Screw Driver','Hardware','146','m38',13,'Rex','- Returned -','2026-03-13','New',1),(29,NULL,'Screw Driver','electronics','aad','fdf',7,'Rex','- Returned -','2026-02-23','Good Condition',1),(30,NULL,'Screw Driver','electronics','f2','fas',13,'Rex','- Returned -','2026-03-13','New',1),(31,NULL,'Pin','electronics','f2as','fasas',24,'Rex','- Returned -','2026-03-13','New',1),(32,NULL,'Screw Driver','electronics','f2asas','fasass',13,'Rex','- Returned -','2026-03-13','New',1),(33,NULL,'Screw Driver','electronics','f2asas1','fasass1',13,'Rex','- Returned -','2026-03-14','New',1),(34,NULL,'Screw Driver','electronics','f2asas1s','fasass1s',13,'Levi','ICTS (Returned)','2026-03-14','New',1),(35,NULL,'Broom','electronics','f2asas1sa','fasass1sa',15,'Levi','Admin (Returned)','2026-02-13','New',1),(36,NULL,'Pin','electronics','f2asas1saa','fasass1saa',24,'Levi','Assessor (Returned)','2026-03-13','New',1),(37,NULL,'Mic','electronics','as232','as12',9,'Aira','DILG (Returned)','2026-04-13','New',1),(38,NULL,'ToolBox','electronics','asd241','23sdsdf',22,'Rose','MPDO (Returned)','2026-04-26','New',1),(39,NULL,'Vaccum','electronics','asd6567','45fgx',4,'Bless','Library (Returned)','2025-01-11','New',1),(40,NULL,'CCTV','electronics','xcv2','cxv3',11,'Jeff','ICTS (Returned)','2026-02-22','Good Condition',1),(41,NULL,'CCTV','electronics','aszc34','xsdf4234',11,'Jeff','ICTS (Returned)','2026-03-13','Defective',1),(42,NULL,'Screw Driver','electronics','asdxc','xcva',13,'Jerrome','ICTS (Returned)','2026-03-16','Good Condition',1),(43,NULL,'Power Cord','electronics','asdxc2','xcva2',7,'Jerrome','Engineering (Returned)','2026-03-16','Defective',1),(44,NULL,'TP Link','asxc7','vbcv934','asdaxc684',14,'Mings','Budget (Returned)','2026-03-16','Good Condition',2),(45,NULL,'Data Cabinet','123sf','123sdf','sdfgsd4',18,'Errold','HRMO (Returned)','2026-03-16','Good Condition',2),(46,NULL,'Access Point','electronics','21sdf1','12sdfxc3',16,'Louie','Tourism (Returned)','2026-03-16','New',3),(47,NULL,'Screw Driver','electronics','asd2cv','xcvewqw',13,'Mark','ICTS (Returned)','2026-03-18','Good Condition',1),(48,NULL,'Screw Driver','electronics','341dvfvz','sfdesfdsf4234',13,'Ellaine','ICTS (Returned)','2026-03-19','New',1),(49,NULL,'Screw Driver','electronics','341dvfvz32','sfdesfdsf42344',13,'Suzaine','ICTS (Returned)','2026-03-19','Good Condition',1),(50,NULL,'Screw Driver','electronics','341dvfvz325','sfdesfdsf423445',13,'Suzaine','ICTS (Returned)','2026-03-19','Defective',1);
...
/*!50001 VIEW `view_all_inventory` AS select `t`.`transaction_id` AS `transaction_id`,`t`.`product_id` AS `product_id`,`t`.`product_name` AS `product_name`,`t`.`product_type` AS `product_type`,`t`.`product_model` AS `product_model`,`t`.`serial_number` AS `serial_number`,`t`.`office_id` AS `office_id`,`t`.`received_by` AS `received_by`,`t`.`borrowed_by` AS `borrowed_by`,`t`.`transaction_date` AS `transaction_date`,`t`.`quality` AS `quality`,`t`.`quantity` AS `quantity`,`o`.`office_name` AS `office_name` from (`transactions` `t` join `offices` `o` on((`t`.`office_id` = `o`.`office_id`))) */;
...
-- Dump completed on 2026-03-19 15:51:24
